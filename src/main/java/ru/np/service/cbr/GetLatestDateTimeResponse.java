...
@XmlRootElement(name = "GetLatestDateTimeResponse", namespace = "http://web.cbr.ru/")
public class GetLatestDateTimeResponse {

    @XmlElement(name = "GetLatestDateTimeResult", namespace = "http://web.cbr.ru/", required = true)
