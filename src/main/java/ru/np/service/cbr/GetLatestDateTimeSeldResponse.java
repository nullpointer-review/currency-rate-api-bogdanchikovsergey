...
@XmlRootElement(name = "GetLatestDateTimeSeldResponse", namespace = "http://web.cbr.ru/")
public class GetLatestDateTimeSeldResponse {

    @XmlElement(name = "GetLatestDateTimeSeldResult", namespace = "http://web.cbr.ru/", required = true)
