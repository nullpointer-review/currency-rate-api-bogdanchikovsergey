...
@XmlRootElement(name = "GetLatestReutersDateTimeResponse", namespace = "http://web.cbr.ru/")
public class GetLatestReutersDateTimeResponse {

    @XmlElement(name = "GetLatestReutersDateTimeResult", namespace = "http://web.cbr.ru/", required = true)
